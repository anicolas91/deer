...
class CZMInterfaceKernelLD : public InterfaceKernelDisconnectedMesh {
public:
  static InputParameters validParams();
  CZMInterfaceKernelLD(const InputParameters &parameters);
...
protected:
  ...
  // values of the traction and traction derivatives of the nieghbor side
  ///@{
  const MaterialProperty<RealVectorValue> &_traction_global_neighbor;
  const MaterialProperty<RankTwoTensor> &_traction_derivatives_global_neighbor;
  ///@}
};
