 ...
 */
class INSDomainIntegralAction : public Action
{
public:
  static InputParameters validParams();

  INSDomainIntegralAction(const InputParameters & params);

  ~INSDomainIntegralAction();
...
protected:
  ...
  /// Vector of velocity
  // std::vector<VariableName> _velocity;
